...
const T: Dict = {
  ...
  onboard_hint: {
    zh: "打开 Claude Code / Codex / Cursor 就会自动出现；状态板会自动接入（可在下方开关中关闭）。",
    en: "Open Claude Code / Codex / Cursor and they'll show up here. Hooks are connected automatically (see the toggles below).",
  },
